 ...
 *   - packages/design-data/registry/*.json  (vocabulary data)
 *   - packages/design-data/fields/*.json    (field catalog declarations)
 *
...
const fieldsDir = join(repoRoot, "packages/design-data/fields");
...
// e.g. "packages/design-data/registry/components.json" → "COMPONENTS_JSON"
...
const categoriesPath = join(
  repoRoot,
  "packages/design-data/registry/categories.json",
);
